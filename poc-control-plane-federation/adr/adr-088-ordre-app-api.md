...
status: "Acté et prouvé hors ligne le 2026-09-03 (scripts/test-selfservice-api-gate-a5.sh 48/48 : stub à journal + 3 mutations, mock Go, câblage, rapport, prototype ; A3 177/177 ; make lint-ci [14/14]) — preuve par builds réels : voir la section « Ce qui est prouvé »."
...
**Statut :** Acté, prouvé hors ligne 48/48 + A3 177/177 + `make lint-ci` [14/14] ; par builds réels sur le lab (`scripts/test-a5-live.sh`, comptes dans « Ce qui est prouvé »).
...
- **Par builds réels** (`scripts/test-a5-live.sh`) : voir le statut du GOAL et la spec (D6) — les comptes y sont écrits après le passage.
