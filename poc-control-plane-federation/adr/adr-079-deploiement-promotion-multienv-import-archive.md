...
date: 2026-07-17
adr_number: 79
note: "Révise le mécanisme de déploiement/MAJ wM par rapport à ADR-076 (rebuild-by-POST) et ADR-078 §7 (update deactivate→PUT→activate). Voir mémoire projet wm-zero-downtime-deploy-constraint."
---
